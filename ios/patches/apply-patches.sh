...
EXPECTED_COMMIT="96620800469421eb437a50a64fcd96d490809258"
EXPECTED_TAG="opengothic-ios-patch-stack-v11"
...
echo "verified: Tempest renderer-ios fork $actual_commit (clean, async present + app-state + borrowed Metal resource/encoder bridges + runtime compilation counters + exact Builtin role attribution + fail-closed offline Builtin/inventory manifests + device-wide binary pipeline archive)"
