...
EXPECTED_COMMIT="29480ece8ec902e0f148b69f940d13a4b2af8398"
...
echo "verified: Tempest renderer-ios fork $actual_commit (clean, async present + app-state + borrowed Metal resource/encoder bridges + runtime compilation counters + exact Builtin role attribution)"
