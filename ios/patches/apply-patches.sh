...
EXPECTED_COMMIT="e92935934ba987dded7a4c554b4a951eb949c836"
...
echo "verified: Tempest renderer-ios fork $actual_commit (clean, async present + app-state + borrowed Metal resource/encoder bridges + runtime compilation counters)"
