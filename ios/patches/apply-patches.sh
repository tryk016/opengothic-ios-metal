...
EXPECTED_COMMIT="53c7d048d194f708f9c9aab948454052349bd764"
...
echo "verified: Tempest renderer-ios fork $actual_commit (clean, async present + app-state + borrowed Metal resource/encoder bridges + runtime compilation counters + exact Builtin role attribution + fail-closed offline Builtin and inventory manifests)"
