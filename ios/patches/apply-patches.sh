...
EXPECTED_COMMIT="6be67631f5a6e26fb6a8084a8524615e6bd33c77"
...
require_literal "$METAL_SHADER" "Builtin SPIR-V interface does not match offline Metal ABI" "offline Builtin fail-closed reflection"
...
echo "verified: Tempest renderer-ios fork $actual_commit (clean, async present + app-state + borrowed Metal resource/encoder bridges + runtime compilation counters + exact Builtin role attribution + fail-closed offline Builtin manifest)"
