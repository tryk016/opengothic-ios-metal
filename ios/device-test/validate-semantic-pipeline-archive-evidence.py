...
def require_cache_bundle(
    ...
    archive = directory / "RendererIOS-abi-10.binaryarchive"
    provenance = directory / "RendererIOS-abi-10.provenance"
...
def self_test() -> None:
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        archive_name = "RendererIOS-abi-10.binaryarchive"
        provenance_name = "RendererIOS-abi-10.provenance"
