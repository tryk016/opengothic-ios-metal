...
def require_cache_bundle(
    ...
    archive = directory / "RendererIOS-abi-12.binaryarchive"
    provenance = directory / "RendererIOS-abi-12.provenance"
...
def self_test() -> None:
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        archive_name = "RendererIOS-abi-12.binaryarchive"
        provenance_name = "RendererIOS-abi-12.provenance"
