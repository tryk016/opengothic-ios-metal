...
inline constexpr uint32_t AbiVersion = 12u;
...
inline constexpr std::string_view InstancedVertexFunction = "riosInstancedVertex";
inline constexpr std::string_view MorphVertexFunction = "riosMorphVertex";
