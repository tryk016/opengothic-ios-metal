...
inline constexpr uint32_t MetallibAbiVersion    = 6u;
...
inline constexpr std::string_view RelativeArchivePath =
    "RendererIOS/PipelineArchives/schema-1/RendererIOS-abi-6.binaryarchive";
...
inline constexpr std::string_view SnapshotStateWorstCase =
    ...
    "metallib=6 cfg=1 available=1 loaded=1 empty=1 dirty=1 disabled=1 "
